...
const BadgeRemove = ({badgeName, onClick}) => (
  <span className="inline-flex items-center py-1 px-2 mr-2 text-sm font-medium rounded border-2 border-blue-400 text-blue-800">
    {badgeName}
    <button type="button" className="inline-flex items-center p-0.5 ml-2 text-sm text-blue-400 bg-transparent rounded-sm hover:bg-blue-200 hover:text-blue-900" onClick={onClick}>
...
BadgeRemove.propTypes = {
  onClick: PropTypes.func,
  badgeName: PropTypes.string,
};

export default React.memo(BadgeRemove);
